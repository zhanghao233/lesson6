                                ...
                                <div class="col-xs-12">
                                    <table id="simple-table" class="table  table-bordered table-hover">
                                        ...
                                        <tr style="font-size: 30px;">
                                            ...
                                            <a href="student/studentMessagePage.do?Number=${Number-1}" style="font-size: 22px">上一页&nbsp;</a>
                                            <span style="font-size: 18px">
                                            总共${TotalPages}页，${TotalElements}条数据，当前第${Number+1}页，当前页面${NumberOfElements}条数据
                                            </span>
                                            </td>
                                            <a href="student/studentMessagePage.do?Number=${Number+1}" style="font-size: 22px">&nbsp;下一页</a>
                                            <%--<span style="font-size: 18px">
                                            &nbsp;&nbsp;&nbsp;&nbsp;第&nbsp;
                                            </span>
                                            ...
                                            <a href="student/getNumberPage.do?number=${number}" style="font-size: 18px">查找</a>--%>
                                        </tr>
                                        </div>
                                </div><!-- /.span -->
                            </div><!-- /.row -->
