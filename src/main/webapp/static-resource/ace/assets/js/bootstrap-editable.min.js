...
!function (a) {
    ...
    a.fn.editableutils.inherit(b, a.fn.editabletypes.text), a.extend(b.prototype, {
        ...
        tpl: '<input type="number">', inputclass: "input-mini",
    ...
    b.prototype = {
        constructor: b, init: function () {
            ...
            var a, b, c = this.fillCommon("M"), d = -1 !== this.options.template.indexOf("MMMM"),
                e = -1 !== this.options.template.indexOf("MMM"), f = -1 !== this.options.template.indexOf("MM");
    ...
    a.extend(a.fn.editableform.Constructor.prototype, {
        initTemplate: function () {
            ...
            b.apply(this);
            var c = null === this.input.options.inputclass || this.input.options.inputclass === !1, d = "input-sm",
    ...
    a.extend(a.fn.editableContainer.Popup.prototype, {
        ...
        defaults: a.fn.popover ? a.fn.popover.Constructor.DEFAULTS : {},
        initContainer: function () {
