...
$.jgrid.extend({
	setColumns : function(p) {
		p = $.extend({
			...
			ShrinkToFit : false,
			jqModal : false,
			saveicon: [true,"left","fa fa-save"],
			closeicon: [true,"left","fa fa-close"],
			onClose : null,
			colnameview : true,
